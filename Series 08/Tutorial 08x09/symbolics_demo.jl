...
# ╔═╡ 8921f953-b68d-4d10-af32-1d98ad80e638
using Symbolics, PlutoUI

# ╔═╡ 451acbb0-beb7-11ed-057c-d3b95759a95c
md"# Symbolics.jl Demonstration"

# ╔═╡ 9f7e2a29-9f80-4008-9e5f-7f0d968a93b8
md"""Citation: [Gowda et al. "High-performance symbolic-numerics via multiple dispatch." ACM Communication in Computer Algebra, Volume 55, Issue 3, September 2021, pp. 92–96.](https://doi.org/10.1145/3511528.3511535)"""

# ╔═╡ 2c7bcf77-5188-4bd0-bcd4-21e484c14902
md"## Load Packages"

# ╔═╡ 3bd6a33d-c78d-4f9e-9ec8-2e35ca79e53a
md"## Define Symbolic Variables"

# ╔═╡ 5c6032c1-781f-497f-9597-e7723f7c7beb
@variables t x y z

# ╔═╡ c8aeff52-3d7a-4d9f-907b-31691c57876a
md"## Examples"

# ╔═╡ c7a848c8-bf1d-487c-9a40-bccfeaf54591
md"### Algebra"

# ╔═╡ dd868ec4-f6d7-469b-91ee-6eac7bcafce1
ex0 = -4//3 * x + y ~ 2

# ╔═╡ 0bc7633a-b762-4370-b907-a5562fc67ae8
Symbolics.solve_for(ex0, x)

# ╔═╡ 285ad6ae-b634-4f9b-9864-a4ac309177f1
Symbolics.solve_for(ex0, y)

# ╔═╡ 5105d935-76b8-4899-ae29-81dd5ebdc1d0
md"### Linear Algebra"

# ╔═╡ d9219d1c-6cd5-4f5b-9b3e-8826961e88eb
ex1 = 3 * x + 2 * y - z ~ 1

# ╔═╡ 8ca8cdfb-6fa0-4f27-a33c-50bcf06c7b83
ex2 = 2 * x - 2 * y + 4 * z ~ -2

# ╔═╡ 0c978b21-2f6f-429a-a87d-2a2f32a2a62f
ex3 = -x + 1//2 * y - z ~ 0

# ╔═╡ 956b8d31-0654-456e-9460-59dbdc65ddd8
Symbolics.solve_for([ex1, ex2, ex3], [x, y, z])

# ╔═╡ b95177fa-4d72-4c50-bdd1-927fbc8a552c
md"Note: Currently, Symbolics.solve_for() only works if all of the equations are linear equations."

# ╔═╡ 33120b62-3529-4f64-a88b-9c324628cec6
md"### Differential Calculus"

# ╔═╡ 11cd2e4c-9c5f-42e0-88a5-f575c8ae937b
D = Differential(t)

# ╔═╡ c546c5eb-dbcf-4466-a1d7-7b5efdab5811
position = -16 * t^2 + 16 * t + 32

# ╔═╡ 85d1829d-e9fe-4c33-9f36-edebddd5d70f
position_dot = D(position)

# ╔═╡ f5f6044c-c2d6-496d-a2e2-00a349fc1c55
velocity = expand_derivatives(position_dot) # first derivative

# ╔═╡ 44824a81-c1ba-47ae-8813-9b71d0e71d16
position_ddot = D(velocity)

# ╔═╡ 700bba8a-272d-4cd1-9117-e659ba078923
acceleration = expand_derivatives(position_ddot) # second derivative

# ╔═╡ 715b8aa2-1de9-4d32-8856-e1da5f402954
md"Time: $(@bind time Slider(0:10, 0, true))"

# ╔═╡ 6782d16d-283a-4759-b576-42e49550fa4e
position_at_time_t = substitute(position, Dict(t => time))

# ╔═╡ 590c4d62-0416-4a6f-bdbd-37e96aaf4cd1
