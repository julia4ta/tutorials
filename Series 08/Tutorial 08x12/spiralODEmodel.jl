...
md"""Source: [Dandekar et al. "Bayesian Neural Ordinary Differential Equations." arXiv, December 14, 2020, last revised February 6, 2022.](https://arxiv.org/abs/2012.07244)"""
...
md"$\begin{align}
\frac{du_1}{dt} &= -\alpha u_1^3 + \beta u_2^3 \\
\frac{du_2}{dt} &= -\beta u_1^3 - \alpha u_2^3
\end{align}$"

# ╔═╡ e52e6144-7c4d-4073-a40a-76f7ab2def88
md"## Define Julia Function"

# ╔═╡ 924cf908-86fe-410b-bbad-5fc629b77eda
function spiralODE(du, u, p, t)
	u1, u2 = u
	alpha, beta = p
	du[1] = du1 = -alpha * u1^3 + beta * u2^3
	du[2] = du2 = -beta * u1^3 - alpha * u2^3
end

# ╔═╡ 9a893fff-6813-4ec8-96a7-87e997d458ca
md"## Assign Variables"

# ╔═╡ bbb765a9-4e38-422e-a871-bc0a1c8e251f
u1_begin = 2.0

# ╔═╡ fba57512-a877-4a8a-8dd3-2f6db3653b47
u2_begin = 0.0

# ╔═╡ 42e6c5f0-e9e0-46e8-b7d6-8780d826695b
u_begin = [u1_begin, u2_begin]
...
# ╔═╡ 7e09a683-7f3a-49a0-8839-efc675374b0a
md"End Time: $(@bind t_end Slider(0:100, 100, true))"

# ╔═╡ e2206e17-1273-4f2c-a957-e2fe10f1aa06
tspan = (t_begin, t_end)

# ╔═╡ 12b0152f-3925-4963-a31b-6ddc5c518cd8
md"alpha: $(@bind alpha Slider(0.01:0.01:0.2, 0.1, true))"

# ╔═╡ ced0e5a5-f3af-46a2-a4c7-8b8635e882f7
md"beta: $(@bind beta Slider(-3.0:0.1:3.0, -2.0, true))"

# ╔═╡ b93ab352-2edb-4290-ac23-8b8a4df1e6c0
p = [alpha, beta]

# ╔═╡ 186fceef-a507-47b1-9fb2-a58f7bd6feaa
prob = ODEProblem(spiralODE, u_begin, tspan, p)
...
plot(sol,
	linewidth = 2,
	title = "Spiral ODE Model (Time Series)",
	xaxis = "Time",
	labels = ["u1" "u2"],
	formatter = :plain,
	widen = true,
...
begin
	phase = plot(sol, idxs = (1, 2),
		legend = false,
		linewidth = 2,
		title = "Spiral ODE Model (Phase Space)",
		xaxis = "u1",
		yaxis = "u2",
		formatter = :plain,
		widen = true,
	...
	scatter!(phase, (u1, u2), color = :red, markersize = 5)
	end
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "0caae34696b3c28fb3dcb4b297bd8132407b221f"
