...
# ╔═╡ fa8fe216-2392-407c-bc9b-e3a9b24daf62
md"## Bernoulli Distribution"

# ╔═╡ 5697de75-441a-49ab-b1a7-9e2ef878e8de
md"Success Rate (p): $(@bind p Slider(0.0:0.01:1.0, 0.5, true))"

# ╔═╡ bd65f5f2-49aa-4762-86b5-7360562f9fd5
bar(Bernoulli(p),
	legend = false,
	xlims = (0, 1),
	ylims = (0, 1),
...
# ╔═╡ 6e26586d-13cd-4d14-8dc8-f9a351f02258
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "1dba4e2f9e739c00dfae2c6906463a6e7a8d2119"
