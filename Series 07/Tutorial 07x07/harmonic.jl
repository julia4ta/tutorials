...
# ╔═╡ a38bd7c3-c201-45bc-9fed-c78670ba78ce
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 662b99b2-50cb-11ed-3d99-13640fa479f4
md"# Simple Harmonic Motion"

# ╔═╡ 18eb8ee1-41ca-4cda-af3e-fb0d51292e53
md"Source: [Wikipedia Article](https://en.wikipedia.org/wiki/Simple_harmonic_motion)"

# ╔═╡ d0627a55-7566-4cda-b909-6376b65dc09a
md"## Add Packages"

# ╔═╡ c7f44a8f-7b67-4ff1-a343-174354671f2f
md"## Describe Problem"

# ╔═╡ 9d74ef9f-b9ce-46ad-b2f8-647c1833aae0
md"### Second Order Ordinary Differential Equation"

# ╔═╡ 6339cb64-55ec-4f08-ad0d-29bf25e084f0
md"From Hooke's Law:"

# ╔═╡ 8f446ff7-5613-472d-9ae8-3bb7ce40e8f3
md"$F_s = -kx$"

# ╔═╡ 70375603-5e10-4f38-a830-082c5e56646c
...
# ╔═╡ 41de4e71-d5d4-416f-93f8-a7b8bb189c3c
md"From Newton's Second Law of Motion:"

# ╔═╡ 05f4330f-66b2-4eaf-b555-b3af770a5c52
md"$F = ma$"

# ╔═╡ 81ea34b5-c772-4476-93cb-f954d685a07d
md"where $m$ is the mass of the object and $a$ is the acceleration."

# ╔═╡ 8225910b-037c-4f48-88d3-b0908bec3dff
md"From the last tutorial:"

# ╔═╡ 83e6be69-cdc3-4dc4-bff7-72b473c9a5df
md"$a = \frac{d^2x}{dt^2}$"

# ╔═╡ 1caa2eed-5025-4fb7-b153-96e080f7bad6
md"where the acceleration, $a$, is the second derivative of position, $x$, with respect to time."

# ╔═╡ 0579607e-793f-4068-8743-3b6e0b439b53
md"Combine equations:"

# ╔═╡ 06c76442-1385-4b2b-b329-c702478aa134
md"$F = m \frac{d^2x}{dt^2} = -kx$"

# ╔═╡ d50b4e3b-1a8f-454e-964e-1abae3580ab1
md"$\frac{d^2x}{dt^2} = - \frac{k}{m} x$"

# ╔═╡ 33a8a825-6ad0-40d5-a895-3f5c8557eb27
...
# ╔═╡ e55c83a8-dc70-4f9f-8314-3d4b7f55cb60
md"#### DifferentialEquations.jl"

# ╔═╡ 99e235dc-652c-44ce-9a33-e06ce86f0bc6
md"$\frac{d^2u}{dt^2} = f(du, u, p, t)$"

# ╔═╡ c7a9e03b-242e-4951-b3db-8f24a6def277
md"##### Simple Harmonic Motion Problem"

# ╔═╡ b3249bee-1285-4a76-97de-64fb5cb16845
md"$f(du, u, p, t) = - \frac{p[1]}{p[2]} u$"

# ╔═╡ 3f4120c3-493c-4e87-b805-c8fa8ffd93e3
md"## Define Julia Function"

# ╔═╡ 23f548a6-68b6-4f1f-bcfa-c083fb9fdaa8
...
# ╔═╡ 6f5a067a-c119-474c-b35e-3ea035bed9c0
md"## Assign Variables"

# ╔═╡ 351534c4-a98b-4bc2-9175-f244c5fdf0f6
md"### du: Velocity in Meters per Second"

# ╔═╡ 1e775604-27da-4ba9-b746-269b4ea135a8
dx_begin = 0.0

# ╔═╡ 7f836e3c-54c1-4eda-857d-f2ce7de4deb7
md"### u: Position in Meters"

# ╔═╡ 673b5fe4-c6bd-453c-a5ac-60fb150abf59
md"### p: Parameters"

# ╔═╡ 6cb09f44-3b98-49ee-bd7a-74c81498fb3f
md"#### k: Spring Constant in Newtons per Meter"

# ╔═╡ 1d6b9dae-b3f5-4c14-933f-9c5efa12b53d
md"#### m: Mass in Kilograms"

# ╔═╡ 21a15006-683e-47dc-9ba2-17516ed92607
md"### t: Time in Seconds"

# ╔═╡ 75238684-08a4-4a55-bbf8-5b8fcfbba92d
t_begin = 0.0

# ╔═╡ b8f47965-855e-4d0b-a892-cdd86990c71c
md"## Define Second Order ODE Problem"

# ╔═╡ c0b002e9-7e64-4354-b9d6-753b410a7151
md"## Solve Problem"

# ╔═╡ 61d84b88-dcf4-4355-a38c-d422f574022e
md"## Plot Solution"

# ╔═╡ 26f88850-b63c-44cb-a535-cba6fd4583fc
@bind reset Button("Reset Sliders")

# ╔═╡ bbf920c3-4325-446f-a9b9-ca8759e02e45
begin
	reset
	md"""
...
# ╔═╡ 1a92efc4-26f5-408f-88e7-574b3a3db0ae
tspan = (t_begin, t_end)

# ╔═╡ 13a8c446-bc5c-4b84-ac7a-30c24bb001cc
begin
	reset
	md"""
...
# ╔═╡ eedd5630-3fa5-4278-b839-6ab5b7c42cf2
p = [k, m]

# ╔═╡ 41f346c1-33db-43d8-89d9-d2b68e376258
prob = SecondOrderODEProblem(harmonic, dx_begin, x_begin, tspan, p)

# ╔═╡ 24789c7a-48ab-49c3-8656-04cb004baff6
sol = solve(prob)

# ╔═╡ d19b45ef-4063-451a-9fbd-952b9eb54c4a
position = sol(t_end)[2]

# ╔═╡ dfc70950-d6ab-40bb-a422-8ddc04858ab8
velocity = sol(t_end)[1]

# ╔═╡ e1936bee-9a79-4d1d-8aa7-aa273a4fcbe1
...
# ╔═╡ 1d67b5fe-6c66-44b3-8778-9456d46e765f
acceleration = -k / m * position

# ╔═╡ e589cd6b-878a-4ca8-a197-8bacb0a09ac9
scatter!(phase, (position, velocity), color = :red, markersize = 5)

# ╔═╡ 9d3cd7ed-ad74-4074-a455-53f112dc5d02
plot(sol,
	legend = (0.8, 0.09),
	linewidth = 2,
...
# ╔═╡ b1ba36d8-ecf0-4bbd-b01f-535dbad6f61e
md"## Appendix: Period (T)"

# ╔═╡ 32e23efe-9cc4-4f57-8126-7e6af3963b01
md"$T = 2 \pi \sqrt{\frac{m}{k}}$"

# ╔═╡ 40d8ebb4-f6e2-465a-9297-2564c24f0c4c
period = 2 * pi * sqrt(m / k)

# ╔═╡ 011cb13d-1995-456e-9293-aafb0ba03cb4
md"""
...
# ╔═╡ 575a5f00-328b-40c7-9211-d339d7128801
