...
# ╔═╡ 8e66e1fe-3841-4098-873f-ea0551bd74fa
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 2960f700-5ba7-11ed-168a-a915309c4f49
md"# Lorenz System"

# ╔═╡ a11ef3f9-fb8e-40b0-a4be-8c83014ede3b
md"Sources:"

# ╔═╡ 75d46638-7d24-4ef7-9392-d7dd6f02b675
md"[Wikipedia Article on Lorenz System](https://en.wikipedia.org/wiki/Lorenz_system)"

# ╔═╡ cbf5753d-5bd3-4b13-b2b5-e79c04dcb05e
...
# ╔═╡ 4b3f5198-47c0-413b-bef7-dedd63073e7f
...
# ╔═╡ cd3a0af0-db63-47d8-b739-a9c8655014e9
md"## Add Packages"

# ╔═╡ c4d81b09-4752-4521-8e0c-9ff2af712fd3
md"## Describe Problem"

# ╔═╡ d3d0ec11-c861-49ff-bbfc-4d8cafd5b528
md"### System of First Order Ordinary Differential Equations"

# ╔═╡ 1563203c-9cd1-451d-9fad-1fad5a9a7693
md"#### Lorenz System"

# ╔═╡ 5d94f132-14a0-4912-84e3-3b675f5f945b
md"$\begin{align}
...
# ╔═╡ 3673745f-2829-4e2a-bc3e-c707a6ee87dc
...
# ╔═╡ d2b2a48c-353e-4dc4-af12-60d216191f5f
...
# ╔═╡ 063d4376-1411-4b58-841f-4418bcb044f8
...
# ╔═╡ 484480a3-e6d7-41c4-8fde-035bade41ad0
md"#### DifferentialEquations.jl"

# ╔═╡ e136fa83-9124-410e-8526-1477d87582c0
md"$f(du, u, p, t) =
\begin{cases}
du[1] = p[1] (u[2] - u[1]) \\
...
# ╔═╡ 62c41207-6377-4348-8894-80ba74be6928
md"## Define Julia Function"

# ╔═╡ 38b2cace-dbf2-44fd-9b74-1977e9cdf07d
...
# ╔═╡ 62d86eb4-5b7f-4481-baf5-cac5282389f8
md"## Assign Variables"

# ╔═╡ cfed122f-9c41-449e-8f72-4e8d4299606c
md"### u: Unknown Functions x, y and z"

# ╔═╡ e005c849-f226-429c-b163-cb5034ae62bb
md"### p: Parameters sigma, rho and beta"

# ╔═╡ 8ce07819-a7f7-42f8-bedf-ef1e5e133c0b
md"### t: Time"

# ╔═╡ 9574b625-b7c3-4a84-8dfc-0e01be385043
t_begin = 0.0

# ╔═╡ bd2f02bf-73f1-408b-8155-909e6f73a83b
t_end = 100.0

# ╔═╡ 1c10c75e-1ce5-43de-b84d-badbf5a54595
tspan = (t_begin, t_end)

# ╔═╡ 486358bc-79a6-4f79-b3eb-c8284af0e36d
md"## Define System of First Order ODEs Problem"

# ╔═╡ f6f3ecbe-84a9-4ea5-81aa-846800fafd7a
md"## Solve Problem"

# ╔═╡ 8d2a4036-42e8-42bf-90eb-5ed3ef37faf0
md"## Prep for Plotting"

# ╔═╡ 961dd53c-ea5f-49f7-b12f-e8a9c1dcb50b
md"### Break Out $t$"

# ╔═╡ 65b79569-3b05-48b6-80c6-3caa5ac6b2ee
md"### Break Out $u$"

# ╔═╡ fc463ec7-41d5-4b97-96ec-205ed14b140a
md"## Plot Solution"

# ╔═╡ 14a1b54a-4bba-419a-9541-fcc53d3f0542
md"### $u$ with Respect to Time Plots"

# ╔═╡ 75ee07d8-2554-4698-8bfa-af2c83ca5f5e
md"### 2-Dimensional Phase Space Plots"

# ╔═╡ a71b19ea-9f38-4717-aef9-03371dcd8560
md"### 3-Dimensional Phase Space Plot"

# ╔═╡ 28fdbc0e-ee11-4523-8dc1-2ea8d700265e
md"#### Control Panel"

# ╔═╡ 73da122f-498c-42c5-b84b-8744f38650a0
@bind reset Button("Reset")

# ╔═╡ 542ebe21-ecc5-4f6c-adb2-1c566793210c
begin
	reset
	md"""
	Initial ||
...
# ╔═╡ 552d4892-8ef1-42f3-9f68-8c00f2e76873
u_begin = [x_begin, y_begin, z_begin]

# ╔═╡ 84feacd6-3b71-4698-97ff-991c62d72166
begin
	reset
	md"""
	Parameters ||
...
# ╔═╡ 747d4b8b-e2cf-4ebb-9893-5d28eb361fa5
p = [sigma, rho, beta]

# ╔═╡ c60118fc-f0c6-46e1-b444-4812c3d6c79b
prob = ODEProblem(lorenz, u_begin, tspan, p)

# ╔═╡ 7013cc83-cfdd-4842-9387-44a3d6ca8689
sol = solve(prob, reltol = 1e-8, abstol = 1e-8)

# ╔═╡ 372f5580-aeb5-4e0f-bcff-cc5bcd629d1c
sol.t

# ╔═╡ da4d66e0-1cf7-413c-9932-b76ddd4fc9c6
n = length(sol.t)

# ╔═╡ 809b7e77-34cf-4be7-ac3f-4dc51df2e89a
begin
	reset
	md"Index: $(@bind idx Slider(1:n, n, true))"
end

# ╔═╡ 79f76cf6-d948-4521-8bf0-481bce6f4256
t = @view sol.t[1:idx]

# ╔═╡ 0fcf8fef-ac47-4fad-a8f9-0264ecbda99f
time = t[idx]

# ╔═╡ 093d16c0-fd43-4289-9ab7-01334a35442f
sol.u

# ╔═╡ 64b3a8d1-e627-4304-a22a-674d4d7f9cc8
u = @view sol.u[1:idx]

# ╔═╡ dbe1d536-4677-4aed-9c28-a5d6e1c23852
sol_u_matrix = reduce(hcat, u)'

# ╔═╡ 15d11a31-d01a-4a2e-8481-4d65e35cfc67
x = sol_u_matrix[:, 1]

# ╔═╡ f41e8b07-a808-4ff9-840b-953ae6cc0723
convection = x[idx]

# ╔═╡ 53f62ed8-0836-4326-819a-a6ac008c72d8
p_x_t = plot(t, x,
	legend = false,
...
# ╔═╡ 416eaf72-32e0-4067-a08b-5fe2265038da
y = sol_u_matrix[:, 2]

# ╔═╡ 4449eb95-914a-4ea2-bc4c-f1286c6e7fd3
horizontal = y[idx]

# ╔═╡ 8ddc7909-1a68-4ee1-870d-e324f5e45428
p_y_t = plot(t, y,
	legend = false,
...
# ╔═╡ 856961a7-1aa4-48f9-882f-58949adcf22e
phase_xy = plot(x, y,
	legend = false,
...
# ╔═╡ 66634549-ea30-4f6f-87b4-92a685c0af8f
z = sol_u_matrix[:, 3]

# ╔═╡ 35a25f40-2571-4a91-bad7-294cc3992955
vertical = z[idx]

# ╔═╡ efad7776-0c3c-4338-bf6a-db9e97935f7f
p_z_t = plot(t, z,
	legend = false,
...
# ╔═╡ a1657618-73f5-4d91-a5a0-94fc401ef405
phase_xz = plot(x, z,
	legend = false,
...
# ╔═╡ 7c97143f-255d-4f9b-90ea-27d67ae86b4e
phase_yz = plot(y, z,
	legend = false,
...
# ╔═╡ c1998b20-28ff-4db8-8a55-2a835e0e6e17
...
# ╔═╡ 22c28be1-4840-4a12-9533-3262180c297c
scatter!(phase_xyz,
...
# ╔═╡ 97727798-4f3f-4306-a9c9-b5265037b4d2
...
# ╔═╡ 93a261bb-d7d5-4a42-b35a-5713d05b4d00
md"""
...
# ╔═╡ d1c20777-666b-4814-8ad8-7ce98d52c56c
