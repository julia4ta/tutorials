...
# ╔═╡ cae7a51f-09f7-437b-a2ce-cf56db1124c8
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ abb84930-612c-11ed-0a4d-899c090674d5
md"# Double Pendulum"

# ╔═╡ 1aef377e-8db2-4762-9497-ea09149c52b0
md"Sources:"

# ╔═╡ 1efacfcd-5369-43f0-985a-7ae7ca44b189
md"[Wikipedia Article on Double Pendulum](https://en.wikipedia.org/wiki/Double_pendulum)"

# ╔═╡ 09213195-9b7c-4568-983a-36e9e6d1617f
...
# ╔═╡ 7580fead-35ea-48d7-a6ba-419884a5de67
md"## Define Julia Function"

# ╔═╡ 269b008b-331d-4dfb-b7b5-23ea4551b408
...
# ╔═╡ 94a68a3e-4849-4c1e-a2af-59a407955193
md"## Assign Variables"

# ╔═╡ d0a1bb49-1901-4de6-9b21-bd7fc37901a0
md"### u: theta1, theta2, omega1 and omega2"

# ╔═╡ 2c767280-f233-43bc-a4c2-4267affae211
omega1 = 0.0

# ╔═╡ afc5b94f-d477-4dfe-9618-40e31957a71a
omega2 = 0.0

# ╔═╡ aa3bb10d-4aa5-459c-82c0-658d33717333
md"### p: Parameters m1, m2, L1, L2 and g"

# ╔═╡ 7c60e9ad-45e7-43cf-9d09-b8be88ced004
md"### t: Time in Seconds"

# ╔═╡ 50eeef99-3b63-4b5f-8b3b-a03be2c1ec3e
t_begin = 0.0

# ╔═╡ 5a2e8c28-ee29-4caf-bca4-635ab260bdc5
md"## Define System of First Order ODEs Problem"

# ╔═╡ 5eed155f-fbe6-4381-aaed-3399fc857fe4
md"## Solve Problem"

# ╔═╡ ed43c0f8-7010-4ca9-a050-34ad1c0bf4a9
md"## Prep for Plotting"

# ╔═╡ f6de64d4-00b7-4e71-b66e-81eb7a28c77b
md"## Plot Solution"

# ╔═╡ b184f2ca-c677-4732-9c20-40f4ed743ff3
md"#### Control Panel"

# ╔═╡ 533f9bbb-4676-481e-9f8a-fec565cebf99
@bind reset Button("Reset")

# ╔═╡ fb4e90b9-4aa3-4853-9164-2d9758e874eb
begin
	reset
	md"Time (s): $(@bind t_end Slider(0.0:0.01:100.0, 100.0, true))"
end

# ╔═╡ afb3d219-fb99-4780-adf1-dc6c0bf1625a
tspan = (t_begin, t_end)

# ╔═╡ 6adc8816-ff15-49ef-be07-4f6510623285
begin
	reset
	md"""
	Initial Conditions ||
...
# ╔═╡ 8632f8ff-e47b-48b7-9304-13c57974e952
theta1 = deg2rad(theta1d)

# ╔═╡ 3b62e051-d380-4449-8b49-220946ec4ef3
theta2 = deg2rad(theta2d)

# ╔═╡ d6b2fbd6-9d16-490d-8034-cbed883b8ea2
u_begin = [theta1, theta2, omega1, omega2]

# ╔═╡ fcf32c98-b101-4d2a-910d-578c815230d6
begin
	reset
	md"""
	Parameters ||
...
# ╔═╡ dfe4a82b-6552-4cc8-b08e-c13bb6460a63
p = [m1, m2, L1, L2, g]

# ╔═╡ 86eaae7a-5d9d-46e6-b357-d749e05b98ec
prob = ODEProblem(double_pendulum, u_begin, tspan, p)

# ╔═╡ e4f16b0c-e8cb-4ebf-8606-621bc872fce3
sol = solve(prob, Vern7(), reltol = 1e-10, abstol = 1e-10)

# ╔═╡ 1b37fb37-511b-4e5d-ac75-71e2e1e529a3
plot(sol);

# ╔═╡ 8c3d44d7-2c9b-40ef-9f6e-3aa43f36486e
...
# ╔═╡ 34f4b742-eb0a-4140-ac3f-3fe456bb3bf8
pendulum1, pendulum2 = polar2cart(sol)

# ╔═╡ a250be15-a895-4a57-b324-45876a1a7f09
x1 = pendulum1[1][end]

# ╔═╡ a9ea57e5-d053-4153-b850-9e799e8288f4
y1 = pendulum1[2][end]

# ╔═╡ 3a7be207-a43a-4101-b70e-d58a9641b158
x2 = pendulum2[1][end]

# ╔═╡ 3e668832-6ff2-4f9e-bbdf-a85eb6dc856e
y2 = pendulum2[2][end]

# ╔═╡ 44e946eb-ada8-4c8c-949e-66568129e8d3
...
# ╔═╡ 0e9fc73e-6072-4d8c-8385-edb4e540fc94
...
# ╔═╡ eee3e8b5-484b-420d-a109-e0493fca627e
begin
	plot!(phase_x2y2,
		([0, x1, x2], [0, y1, y2]),
		color = :black,
...
# ╔═╡ 71b0b207-ba32-4b44-ab25-900464eebe9d
md"""
Time: $(t_end) ||
...
git-tree-sha1 = "b6da0b46c8d03b6c8102b9a21f62fab90a413eef"
