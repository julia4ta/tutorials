...
# ╔═╡ d9e137e4-604a-4d33-8f31-0c37f5681953
...
# ╔═╡ 76769209-1a33-4f15-a326-d4b73c6f0c0b
md"## Describe Problem"

# ╔═╡ 936dc8b0-83f8-4c70-beda-8d5cfcdc1343
md"### System of First Order Ordinary Differential Equations"

# ╔═╡ 1540a362-f924-408c-9be3-eb30930652a2
md"#### Lotka-Volterra Equations"
...
# ╔═╡ e52e6144-7c4d-4073-a40a-76f7ab2def88
...
# ╔═╡ 9a893fff-6813-4ec8-96a7-87e997d458ca
md"## Assign Variables"

# ╔═╡ eeb686ac-e3c8-44c7-80c2-6c176ec01485
md"### u: Populations"

# ╔═╡ 67de6bd7-9175-4f0c-af3d-e5097b101c1a
md"#### x: Populations of Baboons"

# ╔═╡ 1dad5d15-4e1f-47be-9faf-fa11eab9b5c1
md"#### y: Population of Cheetahs"

# ╔═╡ e3d7bfa7-ce61-4d3d-a4b0-ef26f611c793
md"### p: Parameters"

# ╔═╡ df5c2bc2-6af6-4cc9-81d8-ff81ed626726
md"#### alpha: Baboon Population Growth Rate"

# ╔═╡ 41dab4b8-405d-4022-ab39-ca208f876551
md"#### beta: Baboon Decline Rate"

# ╔═╡ 245a9b96-ebc8-46b2-8fa4-12dfb115ee0f
md"#### gamma: Cheetah Population Decline Rate"

# ╔═╡ 3a22b700-8ba5-4271-86f2-f401e46796bf
md"#### delta: Cheetah Population Growth Rate"

# ╔═╡ ba3a058b-38bc-48c2-a00f-47bf20a83b3a
md"### t: Time in Years"

# ╔═╡ 46ee2b7f-9bb8-4a74-bdf1-8c7ebda49c4d
t_begin = 0

# ╔═╡ bfb91476-5b4f-4b09-bd38-8e984d03b0fe
md"## Define System of First Order ODEs Problem"

# ╔═╡ d8142f45-ecb0-4544-9be2-96045f03b51e
md"## Solve Problem"

# ╔═╡ 874abfb7-3565-4dda-ad02-2d1fdf800bb7
md"## Plot Solution"

# ╔═╡ 6429770e-1f83-49fd-bae8-fed7726dd951
@bind reset Button("Reset")

# ╔═╡ 848085ad-fae9-42b3-be6f-27e1010b532d
begin
	reset
	md"Years: $(@bind t_end Slider(0:100, 100, true))"
end

# ╔═╡ e2206e17-1273-4f2c-a957-e2fe10f1aa06
tspan = (t_begin, t_end)

# ╔═╡ 4a9eef56-c860-46fb-854d-57302c6ce0d6
begin
	reset
	md"""
...
# ╔═╡ 42e6c5f0-e9e0-46e8-b7d6-8780d826695b
u_begin = [x_begin, y_begin]

# ╔═╡ 18af3c3a-00cd-4869-95d9-535a8cde65c2
begin
	reset
	md"""
	Baboon Growth:
...
# ╔═╡ b93ab352-2edb-4290-ac23-8b8a4df1e6c0
p = [alpha, beta, gamma, delta]

# ╔═╡ 186fceef-a507-47b1-9fb2-a58f7bd6feaa
prob = ODEProblem(lotka_volterra, u_begin, tspan, p)

# ╔═╡ 55623374-c3aa-4607-ab13-e3d090648079
sol = solve(prob, reltol = 1e-8, abstol = 1e-8)

# ╔═╡ e78aa4ce-c9b5-4360-897f-3cc61f0f353c
baboon = sol(t_end)[1]

# ╔═╡ c366fa68-4a69-4c7d-a20c-57e6db5b0007
cheetah = sol(t_end)[2]

# ╔═╡ c50b5d65-8f7c-4868-86c3-d8c5dd09bfe0
...
# ╔═╡ b2b66968-5962-4dfa-8053-878c63288233
md"""
Populations at Year $(t_end) |
Baboons: $(round(Int, baboon)) |
Cheetahs: $(round(Int, cheetah))
"""

# ╔═╡ bbf7cb12-a4e3-46d2-a686-772998df335b
scatter!(phase, (baboon, cheetah), color = :red, markersize = 5)

# ╔═╡ bc669b3f-85a1-4b01-9309-0733d35285d5
plot(sol,
	legend = (0.78, 0.09),
	linewidth = 2,
...
# ╔═╡ 3e2b0517-2009-4ce1-a2f9-0042967d1e9c
