...
# ╔═╡ 6610e602-de61-4fca-90cf-569deb288861
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 886c93c0-69a9-11ed-3ca4-7107489fabf9
md"# SDE Version of Verhulst Equation"

# ╔═╡ 39c5952e-3840-4438-aba7-3463d076adfc
md"## Add Packages"

# ╔═╡ 603bd23f-3bdb-471d-944e-7f64417a7efd
md"## Define Julia Functions"

# ╔═╡ bfff9e09-9f64-4e26-9dfb-f13eba56d2fc
md"### ODE"

# ╔═╡ 6337c0ec-278a-462e-b266-ab57d29444c6
...
# ╔═╡ 5062d56c-f72a-4315-9efb-21b75dbf2160
md"### Noise"

# ╔═╡ 67638893-017c-4f74-a900-03cc22c89f51
md"## Assign Variables"

# ╔═╡ da3ad96e-61c4-4859-8c77-06c7d0336c1e
md"### u: Population"

# ╔═╡ 828cc228-49a9-49b3-a778-ee3fa92fd0fe
md"### p: Parameters"

# ╔═╡ 26e76bb1-cea3-4100-aa76-33b3f0c25511
md"#### $r$: Growth Rate per Month"

# ╔═╡ 2748d043-5121-4217-8d0a-49e841d1d9d5
md"#### $K$: Maximum Population"

# ╔═╡ 02b28293-83cd-42dd-bbb2-3829de98fa79
md"### t: Time in Months"

# ╔═╡ a62214b7-0dfc-474d-a703-2623e7ff01fe
t_begin = 0.0

# ╔═╡ f2318edd-a128-42c3-b701-9b9a0e6429bb
md"Note: Time Step is required for SDE."

# ╔═╡ 7ee2887c-980f-4a63-864a-b250f9925810
t_step = 0.01

# ╔═╡ 3a3405af-1aa9-4fe6-86ec-7630dd0d81e5
md"## Define Problems"

# ╔═╡ 91a2ad3b-db23-4992-8150-58da945bc912
md"### Define ODE Problem"

# ╔═╡ 36f2b942-ea53-4cde-bcaa-eb5d5dc59bdd
md"### Define SDE Problem"

# ╔═╡ bdbb6825-2029-492b-9df6-a69efd920622
md"## Solve Problems"

# ╔═╡ 08b78737-7212-4f5a-b13f-f3d7b11f1959
md"### Solve ODE Problem"

# ╔═╡ 91d5fefc-f0f7-4db1-a120-57b477a62d1b
md"### Solve SDE Problem"

# ╔═╡ 73ba45c9-4975-4992-b565-720453f98a72
md"## Plot Solutions"

# ╔═╡ 71b3924c-429e-47b9-944a-0874599d04ba
md"### Control Panel"

# ╔═╡ 5a111dc6-6b6f-4fc0-9cdc-3382f22a58bc
md"Maximum Population ($K$): $(@bind K Slider(100.0:200.0, 200.0, true))"

# ╔═╡ 6cf8690b-673b-41d7-83a1-cb063185f0d8
md"Months: $(@bind t_end Slider(0.0:72.0, 72.0, true))"

# ╔═╡ ad7f2987-6ae4-41d0-bea1-4a4ff724fc00
tspan = (t_begin, t_end)

# ╔═╡ 47e49b4f-638a-49c1-b05b-67a6ef6adcd8
md"Beginning Population: $(@bind N_begin Slider(1.0:100.0, 1.0, true))"

# ╔═╡ ad342577-c583-4ed5-ba01-46a9fa804a27
@bind new_plot Button("New Plot")

# ╔═╡ 947c5de8-cc86-40bc-9cd6-c8da0a428a38
@bind new_sol Button("New Solution")

# ╔═╡ 3a108b47-7b23-41e5-bfbf-3048cee9321f
md"Growth Rate ($r$): $(@bind r Slider(0.1:0.01:1.0, 0.14, true))"

# ╔═╡ fba8bca3-c3e9-452c-ae2d-55cd686f60a6
p = [r, K]

# ╔═╡ 30dd6234-6c49-4ed9-a9f1-b0484bdc64ef
prob_ODE = ODEProblem(verhulst, N_begin, tspan, p)

# ╔═╡ f0ca5451-bdc6-4476-b79a-c973a6dc9bc5
sol_ODE = solve(prob_ODE)

# ╔═╡ 10aa8d45-ffae-48be-b95f-ca8c142c9f66
begin
	new_plot
	p_ODE = plot(sol_ODE,
	legend = false,
...
# ╔═╡ e88f30a9-aedb-4afb-8a25-aae69db1b80b
md"Volatility (beta): $(@bind beta Slider(0.0:0.01:0.1, 0.0, true))"

# ╔═╡ 36bebb6f-d8ea-47fc-9ba5-0c3eb17aa119
g(u, p, t) = beta * u

# ╔═╡ cdd26c5e-c5e0-4806-a137-e3a5c354ab54
prob_SDE = SDEProblem(verhulst, g, N_begin, tspan, p)

# ╔═╡ b1e5536c-3fe8-4f58-9251-89364016987d
begin
	new_sol
	sol_SDE = solve(prob_SDE, EM(), dt = t_step)
end

# ╔═╡ c18d25b1-68df-4b6b-8a17-b0795cfd8001
md"Ending Population: $(round(Int, sol_SDE(t_end)))"

# ╔═╡ a3263c2e-75b0-4e3d-92c1-c26345023cd9
...
git-tree-sha1 = "0ed2054d1676d39128fbc8fc536616023e4a40d9"
...
git-tree-sha1 = "23ee21a123ed0f2450a1c50135ab3d5f8aaaf7c3"
