...
md"[DifferentialEquations.jl Documentiation](https://diffeq.sciml.ai/stable/)"

# ╔═╡ bcde3088-bac7-45ff-b91c-13ea8e424c7c
md"## Add Packages"

# ╔═╡ f6d6ee9d-fa77-4bda-96d5-aadb568cfac6
md"## Describe Problem"

# ╔═╡ b436fa1c-6789-4bd8-8ab8-35580af66850
md"### Stochastic Differential Equation (SDE)"

# ╔═╡ 4a2cd290-477d-40d4-85a9-bafb164004ed
md"From the DifferentialEquations.jl package documentation:"

# ╔═╡ 013fc715-c3f4-44b1-8702-ac7c5ef1c159
md"$du = f(u, p, t)dt + g(u, p, t)dW$"

# ╔═╡ 41bf168b-8556-483f-96d7-9611c364adc5
md"where $f(u, p, t) = \alpha u$ and $g(u, p, t) = \beta u$."

# ╔═╡ 85247df1-b553-4acf-b9c3-c81806af9d5a
md"## Define Julia Functions"

# ╔═╡ 7f47264b-bd19-4646-89f9-2de7f78da0e5
md"### ODE"

# ╔═╡ 59d44108-8a80-45d8-a600-f85babcc67f8
md"### Noise"

# ╔═╡ cce48fdb-a381-42a7-bdba-e2902766b966
md"## Assign Variables"

# ╔═╡ 60281625-611b-41bc-947c-3942787d0d84
md"### u: Quantity"

# ╔═╡ f149c025-7a93-4a53-b3aa-f540b85a88ad
u_begin = 1.0

# ╔═╡ 93748c62-a368-4d64-9f6c-7ca13cda0a10
md"### p: Parameters alpha and beta"

# ╔═╡ c725f5de-c8c7-43aa-972a-f78a13439f19
md"### t: Time"

# ╔═╡ c001f557-29d4-4f67-bb9e-608ccf224865
t_begin = 0.0

# ╔═╡ 5290cdf6-b191-420c-9030-4171cc1ece1a
t_end = 1.0

# ╔═╡ bcb21893-3f52-4543-bdde-5715820a92fe
tspan = (t_begin, t_end)

# ╔═╡ 7843b1c0-cf72-4b4b-8923-850cdd228d91
md"Note: Time Step required for EM() solver."

# ╔═╡ 603ed1db-0853-4220-ad5c-284c0de0a82d
t_step = 0.0001

# ╔═╡ 5ad42904-a06d-4926-8f20-938d8753732b
md"## Define Problems"

# ╔═╡ 0356ba8b-d215-4e60-8002-08c0b27a944a
md"### Define ODE Problem"

# ╔═╡ 717fcf6e-935a-4aa1-9a2e-828aec3d0eaf
md"### Define SDE Problem"

# ╔═╡ 81115fe2-c638-4ff3-97b6-567622c6b37b
md"## Solve Problems"

# ╔═╡ 1534497e-a3fe-4f32-bc33-9e01fd8f7186
md"### Solve ODE Problem"

# ╔═╡ f07d6e82-0dc5-405e-a0db-a9b8867fdf8e
md"### Solve SDE Problem"

# ╔═╡ 3d17590a-7af6-4e6e-820e-d901de1e72cd
md"## Plot Solutions"

# ╔═╡ f13a9f73-57ea-4234-8962-d9a1d9b8ed96
md"### Control Panel"

# ╔═╡ b0d36ab1-9056-44f5-9dc1-2f4aeef897f0
@bind new_plot Button("New Plot")

# ╔═╡ 0c3c44c5-41e2-4f00-b216-61cea7cadb93
@bind new_sol Button("New Solution")

# ╔═╡ d8b56abe-6717-4d5e-8182-b69a47d01638
md"Growth Rate (alpha): $(@bind alpha Slider(0.0:0.01:1.0, 1.0, true))"

# ╔═╡ 8985654e-d6a2-4c45-98f5-41bb97b19598
f(u, p, t) = alpha * u

# ╔═╡ 84eec556-25b5-44d3-ad0c-53ccc2b3b093
prob_ODE = ODEProblem(f, u_begin, tspan)

# ╔═╡ 37a3da15-0f67-441d-a2ff-b1eabe4124cb
sol_ODE = solve(prob_ODE)

# ╔═╡ ca750161-f951-40fb-b262-f856176c22c9
begin
	new_plot
	p_ODE = plot(sol_ODE,
		legend = false,
...
# ╔═╡ 3708b7df-cb45-4838-8aa0-eb3b52e5b1db
md"Volatility (beta): $(@bind beta Slider(0.0:0.01:1.0, 0.0, true))"

# ╔═╡ 757531cf-34c5-47b8-b782-8b5d1cfb2060
g(u, p, t) = beta * u

# ╔═╡ 267b5054-50eb-4db9-abeb-a3c194406e22
prob_SDE = SDEProblem(f, g, u_begin, tspan)

# ╔═╡ ba249ee6-5642-4679-be01-b5bdab241877
begin
	new_sol
	sol_SDE = solve(prob_SDE, EM(), dt = t_step)
end

# ╔═╡ 865a6fb5-75a6-4795-af7f-a4ff26f49238
plot!(p_ODE, sol_SDE, alpha = 0.75)

# ╔═╡ ac6558b8-edc8-45f5-a931-c7042b26b358
md"Ending Quantity: $(round(sol_SDE(t_end); digits = 3))"
...
git-tree-sha1 = "78a192625aa84032bde6379f4cb8cef0f3e1ba1b"
...
git-tree-sha1 = "8a6ede7ef017d73b268fc97e6b26e5f915f2fe57"
