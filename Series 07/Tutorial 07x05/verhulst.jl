...
# ╔═╡ 789bd174-5c4c-4f00-8f3a-a11acd43b5d3
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ ecaccdf0-45d2-11ed-174f-c19fe95d2b74
md"# Verhulst Equation"

# ╔═╡ 391dfe07-e611-4631-a76e-abf3b78a3c95
md"Reference: [Wikipedia Article](https://en.wikipedia.org/wiki/Pierre_Fran%C3%A7ois_Verhulst)"

# ╔═╡ ac63f990-0a0c-4079-adde-0baca99dc4de
md"## Add Packages"

# ╔═╡ cbbf908e-e006-48f0-981b-c07f92936396
md"## Describe Problem"

# ╔═╡ 53986845-78b6-4c34-bccb-e48b188ace93
md"### Ordinary Differential Equation (ODE)"

# ╔═╡ 1b23191b-3c98-4ea1-9701-4ec63bc94e09
md"Version of equation popularized by Raymond Pearl and Lowell Reed:"

# ╔═╡ a1e1a659-490a-4e3b-b8a1-1dd39caabdb3
md"$\frac{dN}{dt} = rN \left( 1 - \frac{N}{K} \right)$"

# ╔═╡ b1e0b214-8983-49f3-849d-315c318053cc
md"where $N$ is the population at any time $t$,"

# ╔═╡ ea08397f-a5f2-4477-b304-02fcfbd36b67
md"and $r$ is the growth rate of the population,"

# ╔═╡ 69dab9fb-80f3-430a-b7ce-aa7018c46421
md"and $K$ is the maximum population that the environment can support."

# ╔═╡ 64fef654-829f-4fa9-ad1b-21b269e452ea
md"#### DifferentialEquations.jl"

# ╔═╡ 867300f8-9b68-4e9c-b597-9c13e7c1be4d
md"$\frac{du}{dt} = f(u, p, t)$"

# ╔═╡ 7cd5dd7b-3c4f-412e-885c-8ab14598fbff
md"##### Verhulst Equation Problem"

# ╔═╡ ff17d054-ad76-4726-a738-12f7d599a384
md"$f(u, p, t) = p[1]u \left( 1 - \frac{u}{p[2]} \right)$"

# ╔═╡ 059fc4b6-ad92-4ebd-83ab-0a65ebece961
md"## Define Function"

# ╔═╡ 75860c94-a5e8-4d63-86ca-8f6d4c16f54d
# f(u, p, t) = p[1] * u * (1 - (u / p[2]))

# ╔═╡ a006bb7c-48f1-4f38-a378-440d66d3ba0f
...
# ╔═╡ b6053e64-f1b2-449e-b5a2-c2af833c372f
md"## Assign Variables"

# ╔═╡ 3a231840-a554-4c7e-9440-2e8bf81a9dbd
md"### u: Population"

# ╔═╡ 147b5aa0-a11a-432c-8ba8-3bf6a95cf314
md"### p: Parameters"

# ╔═╡ ff144fa1-11e8-4c2b-82fd-a041f125e787
md"#### $r$: Growth Rate per Month"

# ╔═╡ 2555d2f0-358c-4cdb-863d-7e5d84db38e8
md"#### $K$: Maximum Population"

# ╔═╡ 4e320ca2-0162-4f0e-88f8-1ad67c6e7ca3
md"### t: Time in Months"

# ╔═╡ 6285e2f5-6ada-4f2b-8a95-a44166957420
t_begin = 0.0

# ╔═╡ 3c395752-227b-4723-ba71-629b4a98cbc3
md"## Define ODE Problem"

# ╔═╡ 498d453c-ef0d-42e0-a7b0-729faf5d1192
md"## Solve Problem"

# ╔═╡ 92f69f1a-fd06-47d4-bb42-a84813fff7be
md"## Plot Solution"

# ╔═╡ 71606299-102b-4a83-aa68-537253341ffb
md"Maximum Population ($K$): $(@bind K Slider(100.0:200.0, 200.0, true))"

# ╔═╡ 18985f91-2e86-4416-8112-70538e0a9a16
md"Months: $(@bind t_end Slider(1.0:72.0, 72.0, true))"

# ╔═╡ b51c5d3f-171b-465a-b651-c04e21990a41
tspan = (t_begin, t_end)

# ╔═╡ 2ceebbf3-c652-4777-b210-e1cacc404484
md"Growth Rate ($r$): $(@bind r Slider(0.01:0.01:1.0, 0.14, true))"

# ╔═╡ b7dce3fa-8285-4ee3-a1d3-98b6a6698473
p = [r, K]

# ╔═╡ 0f44db14-ee0d-4cc1-b4a2-3b9a8e737ddc
md"Beginning Population: $(@bind N_begin Slider(1.0:20.0, 1.0, true))"

# ╔═╡ 909c8a63-b37f-446a-bae8-3e6edd0ce410
prob = ODEProblem(verhulst, N_begin, tspan, p)

# ╔═╡ e883bf4c-3917-4e78-b0ba-2da7a803af2c
sol = solve(prob)

# ╔═╡ d1e3ab4e-5cf2-4969-8011-f0a162fc4271
md"Ending Population: $(round(Int, sol(t_end)))"

# ╔═╡ fad56f4d-eb82-4042-8bc8-5f693b35c7a2
plot(sol,
	legend = false,
	linewidth = 2,
...
# ╔═╡ 38d13b99-ed84-4701-ab71-a58be12ff069
